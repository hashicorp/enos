...
// TextEncodeBase64Func constructs a function that encodes a string to a target encoding and then
// to a base64 sequence.
...
// Base64GzipFunc constructs a function that compresses a string with gzip and then encodes the
// result in Base64 encoding.
